<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoanType.aspx.cs" Inherits="RopeyDVDs.LoanType" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server" >
    <div class="body-content" >
       <h2 style="color: #4CAF50  ;">Add Loan Type</h2>
     
          <table style="width:100%;">
                    
                   <tr>
                        <td>
                            <asp:Label ID="Labelloan_id" runat="server" Text="Id"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="tBloan_id" runat="server" Style="border-radius: 0px 8px 0px 8px;" Width="332px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Labelloan_type" runat="server" Text="Loan Type"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="tBloan_type" runat="server" Style="border-radius: 0px 8px 0px 8px;" Width="332px"></asp:TextBox>
                        </td>
                    </tr>
            ...
            <asp:GridView ID="GVactors" runat="server" CssClass="table" AutoGenerateColumns="False" >
                         ...
                         <Columns >
                            ...
                            <asp:TemplateField HeaderText="View" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#4CAF50  ">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("loan_type_id") %>' OnClick="LinkButtonViewActor_Onclick" ForeColor="YellowGreen">View</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
